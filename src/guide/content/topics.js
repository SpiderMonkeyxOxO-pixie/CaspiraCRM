...
export const TOPICS = [
  ...
  },
  {
    ...
    body: [
      ...
      "7. Marketing will bring in new leads through campaigns and forms, feeding step 1. It is still a preview with sample data, so nothing entered there is saved yet.",
  ...
  },
  {
    ...
    body: [
      ...
      "Tools marked Ready to Connect can be connected now. Not Configured means your system owner must first register the CRM with that tool. The area pages (Sales & Marketing, Support & Communication, Projects & Development, Commerce & Finance, Documents & Storage) are still previews with sample data.",
    ],
